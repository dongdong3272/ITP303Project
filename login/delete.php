...
// If not login in, go to the home page
...
<head>
	...
	<title>Delete a Product | ourDeal</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<h1 class="col-12 mt-4 big-text">Delete a Product</h1>
		</div> <!-- .row -->
	</div> <!-- .container -->
	<div class="container">
		<div class="row mt-4">
			<div class="col-12">
				...
				<?php else : ?>
					...
					<div class="text-success our-text">Your Product <span class="font-italic"><?php echo $_GET['product_name']; ?></span> was successfully deleted.</div>
		...
		<div class="row mt-4 mb-4">
			<div class="col-12 our-text">
				<a href="profile.php" role="button" class="btn btn-primary">Back to Profile</a>
			</div> <!-- .col -->
		</div> <!-- .row -->
	</div> <!-- .container -->
</body>
